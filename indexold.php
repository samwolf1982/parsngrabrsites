...
//$result=$html->find('div[id=infoFlat]'); contentInfoFlat  deteiledInfoFlat  p-titleInfo

// поиск по классу
//$result=$html->find('div[class=infoFlat] div[class=contentInfoFlat] div[class=deteiledInfoFla] p[class=titleInfo]');

$result=$html->find('p[class=titleInfo]');




 //$res= $result->find('text');
...
echo "<br>";
 ...
 // $titleInfo=$value->find('p[class=titleInfo]',0);

//  print_r($titleInfo);
       // foreach ($titleInfo as $key1 => $value1) {
...
unset($html);
 ...
 //$res=stage1("http://www.domofond.ru/prodazha-doma-moskva-c3584",'http://www.domofond.ru/');
  ...
  function start(){
       ...
       $res= stage1("https://pyxi.ru/base.php",'https://pyxi.ru/');
//var_dump($tempValue);
